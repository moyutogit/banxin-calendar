...
截至 V0.1.4，开发设计文档阶段 0—5 的代码与自动化验收已完成：
...
- 阶段 4：可配置 Provider、多会话、流式对话、相对日期工具、智能体画像与本地记忆、
  权限范围、功能知识、受控查询工具，以及排班/闹钟提案—确认—执行—撤销闭环。
...
当前 SQLite schema 为 v8；新增表保存用户明确要求记录的本地智能体记忆，新增字段保存
记忆读取权限；API Key 和敏感请求头
仍从未进入业务数据库或普通备份。
